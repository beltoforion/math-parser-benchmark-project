...
//-------------------------------------------------------------------------------------------------
#include "muparser226/muParser.h"

using namespace mu;


//-------------------------------------------------------------------------------------------------
BenchMuParser226::BenchMuParser226(bool bUseBulkMode)
	: Benchmark()
{
...
//-------------------------------------------------------------------------------------------------
double BenchMuParser226::DoBenchmarkStd(const std::string& sExpr, long iCount)
{
	Parser p;
...
//-------------------------------------------------------------------------------------------------
void BenchMuParser226::PreprocessExpr(std::vector<std::string>& vExpr)
{
...
//-------------------------------------------------------------------------------------------------
void BenchMuParser226::PreprocessExpr(std::string&)
{
}

//-------------------------------------------------------------------------------------------------
double BenchMuParser226::DoBenchmarkBulk(const std::string& sExpr, long iCount)
{
...
//-------------------------------------------------------------------------------------------------
double BenchMuParser226::DoBenchmark(const std::string& sExpr, long iCount)
{
	if (m_bUseBulkMode)
	{
...
//-------------------------------------------------------------------------------------------------
std::string BenchMuParser226::GetShortName() const
{
	if (m_bUseBulkMode)
		return "muparser 2.2.6 (omp)";
	else
		return "muparser 2.2.6";
}
